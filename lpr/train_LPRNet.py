...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default=r"D:\LPR-data\LPRNet_data\train", help='the train images path')
    parser.add_argument('--test_img_dirs', default=r"D:\LPR-data\LPRNet_data\test", help='the test images path')
    ...
    parser.add_argument('--lr_schedule', default=[6, 10, 20, 30, 41], help='schedule for learning rate.')
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            loss_val = 0
            torch.save(lprnet.state_dict(), args.save_folder + 'LPRNet_' + '_epoch_' + repr(epoch) + '.pth')
            epoch += 1
        ...
        # backprop
        optimizer.zero_grad()
        # print(log_probs.size(), labels.size())
